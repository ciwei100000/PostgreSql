...
int main (int argc, char const* argv[])
{
    ...
    sql.insertPointQueue("Test", 10.97, 11.5,13.6);
    sql.insertPointQueue("test", 10.97, 11.4,13.6);
    
    sql.updatePointQueue("Test", 10.97,11.4, 22);
    sql.insertPointQueue("test", 1,2,3);
    
    sql.deletePointQueue("Test", 1,2);
